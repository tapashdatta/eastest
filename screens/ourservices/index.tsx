...
const ServiceItem = ({ item, index }: { 
  ...
  return (
    <ImageBackground
      source={item.image} // Changed from { uri: item.image } to item.image for local assets
  ...
  return (
    ...
    >
      <Animated.View style={stylez}>
        ...
        <BodyText style={styles.serviceSubtitle}>{item.subtitle}</BodyText>
        <BodyText style={styles.serviceDescription}>{item.description}</BodyText>
        <View style={styles.serviceMeta}>
          <CaptionText style={styles.serviceDuration}>{item.duration}</CaptionText>
  ...
  const services: ServiceItem[] = [
    {
      ...
      subtitle: 'Experience divine presence',
      duration: '15 MIN',
      icon: Camera,
      component: DailyDarshanScreen,
      bgColor: ['#4facfe', '#00f2fe'],
      image: require('@/assets/ourservices/dailydarshan.jpg'),
      category: 'Worship',
    },
    {
      id: 'lcvs',
      ...
      subtitle: 'Deepen your spiritual knowledge',
      duration: '45 MIN',
      icon: BookOpen,
      component: LCVSScreen,
      bgColor: ['#667eea', '#764ba2'],
      image: require('@/assets/ourservices/lcvs.jpg'),
      featured: true,
      category: 'Education',
    },
    {
      ...
      image: require('@/assets/ourservices/visa.webp'),
      category: 'Newcomers',
      featured: true,
    },
    {
      ...
      subtitle: 'Connect with like-minded souls',
      duration: '60 MIN',
      icon: Heart,
      component: KrishnaClubScreen,
      bgColor: ['#43e97b', '#38f9d7'],
      image: require('@/assets/ourservices/krishnaclub.avif'),
      category: 'Youth',
    },
    {
      ...
      image: require('@/assets/ourservices/bookdistribution.jpg'),
      category: 'Outreach',
    },
    {
      id: 'nitya-seva',
      ...
      image: require('@/assets/ourservices/nityaseva.jpg'),
      category: 'Service',
    },
    {
      ...
      subtitle: 'Служение на русском языке',
      duration: '40 MIN',
      icon: MessageCircle,
      component: RussianCommunityScreen,
      bgColor: ['#ff9a9e', '#fecfef'],
      image: require('@/assets/ourservices/russianspeakers.jpg'),
      category: 'Community',
    },
    {
      id: 'history',
      ...
      subtitle: 'Discover our sacred heritage',
      duration: '25 MIN',
      icon: History,
      component: HistoryScreen,
      bgColor: ['#a8edea', '#fed6e3'],
      image: require('@/assets/ourservices/history.avif'),
      category: 'Heritage',
    },
  ];
